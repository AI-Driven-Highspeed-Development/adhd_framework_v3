...
class ModuleAdder:
    ...
    def add_from_repo(
        ...
        *,
        ...
        try:
            ...
            clone_path = self._clone_repo(repo_url, temp_dir / inferred_name)
    ...
    def _clone_repo(self, repo_url: str, dest: Path) -> Path:
        """Clone a git repository to dest via shallow clone.

        Raises:
            ADHDError: If clone fails.
        """
        self.logger.info("\U0001f504 Cloning repository...")
