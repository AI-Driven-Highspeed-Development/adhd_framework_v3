...
- **When invoked directly** (standalone): Use general best practices from `adhd_framework_context.instructions.md` and `arch-module` skill.
...
### 2. Discovery
-   **MANDATORY READING**: `./.github/instructions/adhd_framework_context.instructions.md` (overview), `./.github/skills/arch-module/SKILL.md` (modules). Also: `logger_util`, `config_manager`, `exceptions` instructions.
-   **If related to MCP modules**: `./.github/skills/arch-mcp/SKILL.md`
-   **If related to CLI commands**: `./.github/skills/arch-cli/SKILL.md`
...
-   **Discovery Checklist**: Check existing tests, HyperRed findings, and playground. See `red-testing` skill for folder locations.
