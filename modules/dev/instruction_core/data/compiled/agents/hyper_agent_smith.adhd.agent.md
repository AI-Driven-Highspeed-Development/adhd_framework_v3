...
- Reference `smith-skills` skill for format requirements.

### 2. Drafting

**For Agents**: Create `.flow` + `.yaml` sidecar in `modules/dev/instruction_core/data/flows/agents/`. The `.flow` contains body (using Flow DSL), the `.yaml` contains frontmatter (name, description, tools, handoffs). Reference `smith-agents` skill for required sections. Use `_lib/` shared fragments.
**For Prompts**: Use template from `smith-prompts` skill. Name: `snake_case.prompt.md`. Place in `modules/dev/instruction_core/data/prompts/`.
**For Instructions**: Use template from `smith-instructions` skill. Name: `snake_case.instructions.md`. Place in `modules/dev/instruction_core/data/instructions/`.
**For Skills**: Create `SKILL.md` in `modules/dev/instruction_core/data/skills/<skill-name>/`. Reference `smith-skills` skill for format. Directory name uses kebab-case.
...
- **Anti-Drift**: After any trim, verify no CRITICAL rules were weakened. Cross-reference `smith-agents` skill if uncertain.
...
- Agents: `./.github/skills/smith-agents/SKILL.md`
- Prompts: `./.github/skills/smith-prompts/SKILL.md`
- Instructions: `./.github/skills/smith-instructions/SKILL.md`
- Flow DSL: `./modules/dev/flow_core/manual.md`, `./.github/skills/smith-flows/SKILL.md`
- Module Instructions: `./.github/skills/smith-module-instructions/SKILL.md`
- Module READMEs: `./.github/skills/smith-modules-readme/SKILL.md`
- Shared fragments: `./modules/dev/instruction_core/data/flows/_lib/patterns/`
- Skills: `./.github/skills/smith-skills/SKILL.md`
